...
- Adjust translate: "Left", "Right", or "Klein".
...
from GyroBN.Geometry.hyperbolic import Poincare, Hyperboloid, Klein
from GyroBN.GyroBNH import GyroBNH

# ========== Config ==========
th.manual_seed(42)
model_name = "Klein"  # "Poincare", "Hyperboloid", "Klein"
translate='Left' #'Left', 'Right'
K = -2.0
bs, d = 30, 10
shape = [d]
dtype = th.float64
...
# ========== Generate manifold ==========
manifold_classes = {"Poincare": Poincare, "Hyperboloid": Hyperboloid, "Klein": Klein}
...
# ========== Initialize GyroBN ==========
bn = GyroBNH(shape=shape, model=model_name, K=K, translate=translate).to(dtype)
